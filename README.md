...
# 6. If you call `wait()`, any subsequent calls to `runNextStep()` do nothing. If you pass a callback into `wait()`, it'll be called in the event the queue stops waiting.
queue.wait(function(){
  console.log("We've stopped waiting!");
});
